...
home='/home/vincelf/upload'
gt_color='b1-09517_Clipped.png'
gt_color_pred='b1-09517_Clipped_pred.jpg'

gt_color_f = os.path.join(home, gt_color)
gt_color_pred_f = os.path.join(home, gt_color_pred)
gt_color_img = io.imread(gt_color_f)
gt_color_img.shape
set( tuple(v) for m2d in gt_color_img for v in m2d )

gt_color_pred_img = io.imread(gt_color_pred_f)
gt_color_pred_img.shape
set( tuple(v) for m2d in gt_color_pred_img for v in m2d )
```
