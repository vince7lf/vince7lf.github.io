...
{ \
	...
	split($38,POM_5V_GPU,"/"); \
	split($40,POM_5V_CPU,"/"); \
	print $1,RAM[1],RAM[2],SWAP[1],SWAP[2],$11,$12,$13,$14,$15,$16,$17,$18,$20,$22,$24,$26,$28,$30,$32,$34,POM_5V_IN[1],POM_5V_IN[2],POM_5V_GPU[1],POM_5V_GPU[2],POM_5V_CPU[1],POM_5V_CPU[2]; \
};
END {}; \'

1594343173,2410,3956,314,1978,1,1479,0,1479,1,1479,1,1479,0,0,27,29.5,100,29,38.5,29,2159,2159,166,166,332,332
```
* header:
```
(TODO:unixepochtime),ramused,ramtotal,swapused,swaptotal,cached,cpu1per,cpu1freq,cpu2per,cpu2freq,cpu3per,cpu3freq,cpu4per,cpu4freq,emcfreq,gr3dfreq,plltemp,cputemp,pmictemp,gputemp,aotemp,thermal,pom5vincurr,pom5vinavg,pom5vgpucurr,pom5vgpuavg,pom5vcpucurr,pom5vcpuavg
```
...
{ \
	...
	split($46,POM_5V_GPU,"/"); \
	split($48,POM_5V_CPU,"/"); \
	print $1,RAM[1],RAM[2],SWAP[1],SWAP[2],$15,$16,$17,$18,$19,$20,$21,$22,$24,$25,$27,$28,$30,$32,$34,$36,$38,$40,$42,POM_5V_IN[1],POM_5V_IN[2],POM_5V_GPU[1],POM_5V_GPU[2],POM_5V_CPU[1],POM_5V_CPU[2]; \
};
END {}; \'
```
* donne le résultat suivant: 
```
1594350022,2745,3956,342,1978,6,1479,0,1479,1,1479,3,1479,2,1600,0,921,25,28.5,29.5,100,30,38.5,29.5,2322,2343,165,182,373,400
```
...
```
              total        used        free      shared  buff/cache   available
Mem:           3956        3149         500         143         306         503
Low:           3956        3455         500
High:             0           0           0
Swap:          1978         309        1668
Total:         5934        3459        2168

              total        used        free      shared  buff/cache   available
Mem:           3956        3138         495         143         322         509
Low:           3956        3460         495
High:             0           0           0
Swap:          1978         323        1654
Total:         5934        3461        2150

              total        used        free      shared  buff/cache   available
Mem:           3956        3135         494         143         326         512
Low:           3956        3462         494
High:             0           0           0
Swap:          1978         326        1651
Total:         5934        3462        2145
```
* en cela
```
3956,3149,500,143,306,503,3956,3455,500,0,0,0,1978,309,1668,5934,3459,2168
3956,3138,495,143,322,509,3956,3460,495,0,0,0,1978,323,1654,5934,3461,2150
3956,3135,494,143,326,512,3956,3462,494,0,0,0,1978,326,1651,5934,3462,2145
```
* header:
```
